          ...
          {domains.length > 0 ? (
            ...
            <div className="border border-amber-200 bg-amber-50 rounded-xl p-4 mb-6">
              <div className="flex gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-amber-800">No domain restrictions</p>
                  <p className="text-sm text-amber-700 mt-1">
                    Without allowed domains, <strong>anyone</strong> can embed your widget on their website and send messages to your Slack/Discord. We recommend adding at least your main domain.
                  </p>
                </div>
              </div>
            </div>
